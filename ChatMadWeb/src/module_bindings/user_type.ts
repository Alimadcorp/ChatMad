  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("pfp", AlgebraicType.createStringType()),
      new ProductTypeElement("status", AlgebraicType.createOptionType(AlgebraicType.createStringType())),
      new ProductTypeElement("lastActive", AlgebraicType.createTimestampType()),
      new ProductTypeElement("joined", AlgebraicType.createTimestampType()),
      new ProductTypeElement("aura", AlgebraicType.createI32Type()),
